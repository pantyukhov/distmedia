...
export class PostListA extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div>
      <div style={{ width: '100%', height: '50px', backgroundColor: 'rgb(0, 188, 212)'}}>
        <Button onClick={this._newPostClick} style={{ float: 'right'}} variant="text">New post</Button>
      </div>
        {/* posts */}
...
const PostList = withRouter(PostListA);
